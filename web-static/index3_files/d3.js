!function () {
	...
	function Y(n, t) {
		...
		if (e.createSVGPoint) {
			...
			return wa ? (r.x = t.pageX, r.y = t.pageY) : (r.x = t.clientX, r.y = t.clientY),
	...
	function ot(n, t, e) {
		...
		r = ct(r) * Oa,
		i = ct(i) * Ya,
		gt(lt(3.2404542 * u - 1.5371385 * r - .4985314 * i), lt( - .969266 * u + 1.8760108 * r + .041556 * i), lt(.0556434 * u - .2040259 * r + 1.0572252 * i))
	}
	function at(n, t, e) {
	...
	function St(n, t, e, r) {
		...
		s = null;
		return !Go.XDomainRequest || "withCredentials" in c || !/^(http(s)?:)?\/\//.test(n) || (c = new XDomainRequest),
	...
	function zt(n) {
		...
		return function (n) {
			...
			return function (n) {
				...
				e += v,
				n = x + M,
				("<" === o ? e + n + b : ">" === o ? b + e + n : "^" === o ? b.substring(0, _ >>= 1) + e + n + b.substring(_) : e + (y ? n : b + n)) + d
			}
		}
	}
	function qt(n) {
	...
	function Rt(n, t, e) {
		...
		function u(e) {
			return t(e = n(new ec(e - 1)), 1),
			e
		}
		function i(n, e) {
			return t(n = new ec(+n), e),
			n
		}
		function o(n, r, i) {
			var o = u(n),
		...
		return function (u, i) {
			...
			y = {
				...
				polygonEnd : function () {
					...
					g = Xo.merge(g);
					var n = Le(m, p);
					g.length ? we(g, Ne, n, e, i) : n && (i.lineStart(), e(null, null, 1, i), i.lineEnd()),
					i.polygonEnd(),
					g = p = null
				},
				sphere : function () {
	...
	function ze(n) {
		...
		return {
			...
			point : function (i, o) {
				var a = i > 0 ? Sa : -Sa,
				c = oa(i - e);
				oa(c - Sa) < Aa ? (n.point(e, r = (r + o) / 2 > 0 ? Ea : -Ea), n.point(u, r), n.lineEnd(), n.lineStart(), n.point(a, r), n.point(i, r), t = 0) : u !== a && c >= Sa && (oa(e - u) < Aa && (e -= u * Aa), oa(i - a) < Aa && (i -= a * Aa), r = qe(e, r, i, o), n.point(u, r), n.lineEnd(), n.lineStart(), n.point(a, r), t = 0),
				n.point(e = i, r = o),
				u = a
			},
			lineEnd : function () {
		...
		return function (a) {
			...
			N = {
				...
				polygonEnd : function () {
					...
					e = k && t,
					u = v.length;
					(e || u) && (a.polygonStart(), e && (a.lineStart(), s(null, null, 1, a), a.lineEnd()), u && we(v, i, t, s, a), a.polygonEnd()),
					v = d = m = null
				}
			};
			return N
	...
	function ir(n) {
		return function (t, e) {
			return t += n,
			[t > Sa ? t - ka : -Sa > t ? t + ka : t, e]
		}
	}
	function or(n) {
		var t = ir(n);
		return t.invert = ir(-n),
		t
	}
	function ar(n, t) {
		function e(n, t) {
	...
	function wu(n, t) {
		...
		arguments.length ? e = t / ka * Math.asin(1 / n) : (n = 1, e = t / 4),
		function (r) {
	...
	function Lu(n) {
		...
		this.rotate = (r ? Math.atan2(t[1], t[0]) : Math.atan2(-e[0], e[1])) * La,
	...
	function Vu(n, t) {
		return Xo.rebind(n, t, "sort", "children", "value"),
		n.nodes = n,
		n.links = Wu,
		n
	}
	...
	Xo.median = function (t, e) {
		...
		t = t.filter(n),
		t.length ? Xo.quantile(t.sort(Xo.ascending), .5) : void 0
	},
	...
	ya.insert = function (n, t) {
		return arguments.length < 2 && (t = P(this)),
		da.insert.call(this, n, t)
	},
	...
	Xo.touches = function (n, t) {
		return arguments.length < 2 && (t = m().touches),
		t ? Bo(t).map(function (t) {
			var e = Y(n, t);
	...
	Xo.behavior.zoom = function () {
		...
		function g() {
			...
			o(n),
			r(Math.pow(2, Xo.event.shiftKey ? Math.ceil(s) - 1 : Math.floor(s) + 1)),
			u(e, i),
			a(n),
			c(n)
		}
	...
	Xo.formatPrefix = function (n, t) {
		var e = 0;
		return n && (0 > n && (n *= -1), t && (n = Xo.round(n, Nt(n, t))), e = 1 + Math.floor(1e-12 + Math.log(n) / Math.LN10), e = Math.max(-24, Math.min(24, 3 * Math.floor((0 >= e ? e + 1 : e - 1) / 3)))),
		Ka[8 + e / 3]
	};
	var Qa = /(?:([^{])?([<>=^]))?([+\- ])?([$#])?(0)?(\d+)?(,)?(\.-?\d+)?([a-z%])?/i,
	nc = Xo.map({
	...
	["sunday", "monday", "tuesday", "wednesday", "thursday", "friday", "saturday"].forEach(function (n, t) {
		...
		var e = tc[n] = Rt(function (n) {
				return (n = tc.day(n)).setDate(n.getDate() - (n.getDay() + t) % 7),
				n
			}, function (n, t) {
	...
	Xo.geo.bounds = function () {
		...
		_ = {
			...
			polygonEnd : function () {
				...
				_.lineStart = e,
				_.lineEnd = r,
				0 > hc ? (l =  - (h = 180), f =  - (g = 90)) : y > Aa ? g = 90 : -Aa > y && (f = -90),
				M[0] = l,
				M[1] = h
			}
		};
	...
	Xo.geo.albersUsa = function () {
		...
		n.translate = function (t) {
			...
			r = o.translate([l - .307 * s, f + .201 * s]).clipExtent([[l - .425 * s + Aa, f + .12 * s + Aa], [l - .214 * s - Aa, f + .234 * s - Aa]]).stream(c).point,
			u = a.translate([l - .205 * s, f + .212 * s]).clipExtent([[l - .214 * s + Aa, f + .166 * s + Aa], [l - .115 * s - Aa, f + .234 * s - Aa]]).stream(c).point,
			n
		},
		n.scale(1070)
	};
	...
	Rc = {
		...
		polygonEnd : function () {
			Rc.lineStart = Rc.lineEnd = Rc.point = g,
			Cc += oa(Nc / 2)
		}
	},
	Dc = {
	...
	Xo.geo.path = function () {
		function n(n) {
			return n && ("function" == typeof a && i.pointRadius(+a.apply(this, arguments)), o && o.valid || (o = u(i)), Xo.geo.stream(n, o)),
			i.result()
		}
		function t() {
			return o = null,
	...
	Xo.geo.rotation = function (n) {
		function t(t) {
			return t = n(t[0] * Na, t[1] * Na),
			t[0] *= La,
			t[1] *= La,
			t
		}
		return n = ur(n[0] % 360 * Na, n[1] * Na, n.length > 2 ? n[2] * Na : 0),
		t.invert = function (t) {
			return t = n.invert(t[0] * Na, t[1] * Na),
			t[0] *= La,
			t[1] *= La,
			t
		},
				...
				do {
					...
					if (n === u.L) {
						if (t = u.R, t.C && (t.C = !1, u.C = !0, Gr(this, u), t = u.R), t.L && t.L.C || t.R && t.R.C) {
							t.R && t.R.C || (t.L.C = !1, t.C = !0, Kr(this, t), t = u.R),
							t.C = u.C,
							u.C = t.R.C = !1,
							Gr(this, u),
							n = this._;
						...
						t.L && t.L.C || (t.R.C = !1, t.C = !0, Gr(this, t), t = u.L),
						t.C = u.C,
						u.C = t.L.C = !1,
						Kr(this, u),
						n = this._;
	...
	Xo.layout.force = function () {
		...
		a.drag = function () {
			return e || (e = Xo.behavior.drag().origin(bt).on("dragstart.force", Fu).on("drag.force", t).on("dragend.force", Ou)),
			arguments.length ? (this.on("mouseover.force", Yu).on("mouseout.force", Iu).call(e), void 0) : e
		},
		Xo.rebind(a, c, "on")
	};
	var us = 20,
		...
		function n(n, i) {
			...
			function c(n, t, r) {
				if (t) {
					...
					i && !ci(c) && (c._tree.thread = i, c._tree.mod += s - h, r = n)
				}
				return r
			}
	...
	Xo.layout.pack = function () {
		function n(n, i) {
			...
			return ki(a, c / 2, s / 2, t ? 1 : 1 / Math.max(2 * a.r / c, 2 * a.r / s)),
			o
		}
		var t,
	...
	Xo.layout.treemap = function () {
		...
		i.padding = function (n) {
			...
			if (!arguments.length)
				return l;
			var r;
			return f = null == (l = n) ? zi : "function" == (r = typeof n) ? t : "number" === r ? (n = [n, n, n, n], e) : e,
			i
		},
		i.round = function (n) {
	...
	Xo.svg.brush = function () {
		function n(i) {
			i.each(function () {
				...
				s && (l = Ri(s), h.attr("y", l[0]).attr("height", l[1] - l[0]), r(f)),
				t(f)
			})
		}
		function t(n) {
		...
		function u() {
			...
			function v() {
				...
				u = !1;
				M && (n[0] += M[0], n[1] += M[1]),
				C || (Xo.event.altKey ? (x || (x = [(l[0] + l[1]) / 2, (f[0] + f[1]) / 2]), L[0] = l[ + (n[0] < x[0])], L[1] = f[ + (n[1] < x[1])]) : x = null),
				E && m(n, c, 0) && (e(S), u = !0),
				A && m(n, s, 1) && (r(S), u = !0),
				u && (t(S), w({
						type : "brush",
			...
			function m(n, t, e) {
				...
				C ? u = (r += p) + d : (x && (p = Math.max(c, Math.min(s, 2 * x[e] - r))), r > p ? (u = r, r = p) : u = p),
		...
		return n.event = function (n) {
			n.each(function () {
				...
				e = this.__chart__ || t;
				this.__chart__ = t,
				ks ? Xo.select(this).transition().each("start.brush", function () {
					i = e.i,
					o = e.j,
					l = e.x,
					f = e.y,
	...
	Ds.iso = Date.prototype.toISOString && +new Date("2000-01-01T00:00:00.000Z") ? Oo : Us,
	Oo.parse = function (n) {
		var t = new Date(n);
		return isNaN(t) ? null : t
	},
	Oo.toString = Us.toString,
	tc.second = Rt(function (n) {
