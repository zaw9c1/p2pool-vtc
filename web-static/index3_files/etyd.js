...
function updateStats() {
    ...
    d3.json("/local_stats", function (n) {
		...
		d3.select("#share_6hour").text(n.my_share_counts_in_last_hour.unstale_shares6);
		d3.select("#share_8hour").text(n.my_share_counts_in_last_hour.unstale_shares8);
		d3.select("#share_10hour").text(n.my_share_counts_in_last_hour.unstale_shares10);
